...
# Ketikkan teks atau kode "Hello World" pada baris pertama.
# Ketikkan 1+5 pada baris kedua.
"Hello World"
1 + 5
...
# Buat satu rangkaian angka 5 s/d 10 dengan menggunakan function c.
c(5:10)

## Variable

# Buatlah satu variable dengan nama pi dan isilah dengan nilai 3.14.
# Tampilkanlah isi variable pi.
budi_berat_kg <- 68
santi_berat_kg <- 54.5
...
## Package yang dibutuhkan untuk membaca file Excel?
